...
function researchJan_(names, hw, learned) {
  ...
  var prompt =
    ...
    '\n【探し方】★検索は「JANを見つけるため」だけに使ってください。\n' +
    '　日本語タイトルを決めるのに web_search を使ってはいけません（あなたの知識で決められます。実測で12/12正解でした）。\n' +
    '　検索の回数には上限があるので、日本語名を調べるのに使うと【JANを探す回数が無くなります】。\n' +
    '　まず全商品の日本語タイトルを頭の中で決めてから、検索を始めてください。\n' +
    '　JANが見つからなかった商品には、まだ検索の余裕がある限り追加で試してください。\n' +
    '\n この順で試します。1つ当たれば次の商品へ。\n' +
    '　① 「<日本語タイトル> ' + (hw || 'ゲーム') + ' JAN」\n' +
    ...
    '・ただし【探さずに諦めない】。実測で「型番は取れたのにJANが空」が多発しました。型番が取れた商品は\n' +
    '　その商品ページにJANも載っていることが多いので、必ずJANまで確認してください。\n' +
