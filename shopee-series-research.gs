...
function researchJan_(names, hw, learned) {
  ...
  var prompt =
    ...
    // ★ポータル側が「／ 日本語」や「／ 候補:A|B」を付けて送ってくる。
    //   実在するタイトル表から拾った文字列なので、当てるより選ぶ方が正確（2026-08-31）。
    '　名前のうしろに「／ 日本語」が付いていたら、それが【実在するタイトル表から引いた正解】です。そのまま使ってください。\n' +
    '　「／ 候補:A|B」が付いていたら、それは【似ているタイトルの候補】です。合うものがあれば使い、合わなければ無視してください。\n' +
    '　※候補は参考です。合わないのに無理に当てはめないでください。\n' +
